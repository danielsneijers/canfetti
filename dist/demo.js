!(function (t, e) {
  ...
  return (function (n) {
              ...
              var l = (function () {
                function r(t) {
                  ...
                  !(function (t, e) {
                    ...
                    (this.gravity = new s(0, 9.8)),
                    (this.ctx = t),
                    (this.position = new s(e, n)),
                    (this.velocity = new s(
                  ...
                  !(function (t, e) {
                    ...
                    ((e = r.call(this)).addNewParticlesToStream = function () {
                      for (var t = 0; t < e.particlesAmount / 60; t += 1)
                        e.particlesArray.push(
                          new l(e.ctx, e.randomCenterX, -10)
                        );
                    }),
                    (e.ctx = t);
                  ...
                  })(i, [
                    {
                      ...
                      value: function () {
                        this.shouldRender && this.addNewParticlesToStream(),
                          w(P(i.prototype), 'drawConfetti', this).call(this);
                      },
                    },
                    {
                      key: 'randomCenterX',
    ...
    function (t, e, n) {
      ...
      var r = n(0),
        i = new (n.n(r).a)(),
        o = document.getElementById('startButton'),
        a = document.getElementById('stopButton'),
        u = document.getElementById('burstToggle');
      i.startBurst(),
